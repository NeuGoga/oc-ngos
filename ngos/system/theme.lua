...
local palettes = {
    high = {
        ...
        ocean = { bg = 0x0F1C2E, header = 0x07111A, headerText = 0x00FFFF, accent = 0x3A86FF, text = 0xE0FBFC, warn = 0xFFD166, err = 0xEF476F, black = 0x000000, white = 0xFFFFFF, gray = 0x3D5A80 }
    },
    low = {
        ...
        ocean = { bg = 0x000000, header = 0x333333, headerText = 0x00FFFF, accent = 0x0000FF, text = 0xFFFFFF, warn = 0xFFFF00, err = 0xFF0000, black = 0x000000, white = 0xFFFFFF, gray = 0x555555 }
    }
}
